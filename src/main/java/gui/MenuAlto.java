...
public class MenuAlto extends JMenuBar{
    ...
    public MenuAlto(JFileChooser fileChooser,PannelloDisegno pd,JFrame frame){
        ...
        JMenuItem nuovo=new JMenuItem("Nuovo",new ImageIcon("./src/main/java/gui/resources/icons8-aggiungi-file-15.png"));
        ...
        JMenuItem carica=new JMenuItem("Carica",new ImageIcon("./src/main/java/gui/resources/icons8-caricare-12.png"));
        ...
        JMenuItem salva=new JMenuItem("Salva",new ImageIcon("./src/main/java/gui/resources/icons8-salva-12.png"));
